...
const StudentAnalyticsTab: React.FC<StudentAnalyticsTabProps> = ({
  ...
  const themeStyles = {
    cardBackground: theme === 'dark' ? '#1f1f1f' : '#ffffff',
    borderColor: theme === 'dark' ? '#404040' : '#e8e8e8',
      ...
      <Row gutter={[16, 16]}>
        ...
        <Col span={12}>
          ...
          >
            ...
            />
            {growthData.topTags.positive.length === 0 && (
              <Empty description="暂无积极标签" image={Empty.PRESENTED_IMAGE_SIMPLE} />
            )}
          </Card>
        </Col>
        ...
        <Col span={12}>
          ...
          >
            ...
            />
            {growthData.topTags.negative.length === 0 && (
              <Empty description="暂无消极标签" image={Empty.PRESENTED_IMAGE_SIMPLE} />
            )}
          </Card>
        </Col>
      </Row>
